...
frmTextEditor.getContentPane().setLayout(new BorderLayout(0, 0));
    ...
    JLabel lblThisEditorIs = new JLabel("This Editor is designed in Java Swing as a project for Let's GrowMore");
    mnInfo.add(lblThisEditorIs);
    
    JSeparator separator = new JSeparator();
    mnInfo.add(separator);
    
    JLabel lblDevelopedByYashika = new JLabel("& Developed By JOSHI DIVYANG");
